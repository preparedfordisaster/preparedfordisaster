...
###### Note: All instructions below are for use with httpie but can be changed accordingly to your favorite command line tool for making REST requests.
## How to run Tests:

In the command write **gulp** to run a linter and run all the unit mocha tests.
